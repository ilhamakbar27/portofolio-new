  ...
  return (
    <section id="projects" className="py-24 md:py-32">
      <div className="container">
        <h2 className="text-4xl md:text-7xl lg:text-8xl first-letter:uppercase ">
          selected works
        </h2>
        <div className="mt-10 lg:mt-20 md:mt-16">
          {projects.map(({ name, image }) => (
            <a
              key={name}
              className="border-t  group/project relative lg:py-10 flex flex-col border-b border-stone-400 border-dotted py-6"
              href="#"
            >
